...
interface Props<T extends string> {
  ...
  onChange: (event: React.MouseEvent<HTMLElement, MouseEvent>, value: string | any) => void;
  styles?: string;
}
...
const RenderToggleButtons = <T extends string>({ buttons, value, buttonProps = {}, onChange, styles }: Props<T>) => {
